...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:bitconex_team/Resources/Private/Language/locallang_db.xlf:tx_bitconexteam_domain_model_member',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_bitconexteam_domain_model_member',
                'foreign_table_where' => 'AND {#tx_bitconexteam_domain_model_member}.{#pid}=###CURRENT_PID### AND {#tx_bitconexteam_domain_model_member}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'lastname' => [
            'exclude' => true,
            'label' => 'LLL:EXT:bitconex_team/Resources/Private/Language/locallang_db.xlf:tx_bitconexteam_domain_model_member.lastname',
            'description' => 'LLL:EXT:bitconex_team/Resources/Private/Language/locallang_db.xlf:tx_bitconexteam_domain_model_member.lastname.description',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
